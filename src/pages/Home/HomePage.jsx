          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-5xl text-text-main leading-snug mb-6">
              ...
              <span className="italic text-primary">
                cậu ấy là người bạn đồng hành lắng nghe bạn khi bạn cần
              </span>
            </h2>

            <p className="font-body text-text-sub text-base md:text-lg leading-relaxed mb-14 max-w-2xl mx-auto">
              Được xây dựng dựa trên các nguyên lý tâm lý học tích cực, Dora
              đồng hành cùng bạn trên hành trình chăm sóc sức khỏe tinh thần mỗi
              ngày - nhẹ nhàng, không phán xét, luôn sẵn sàng.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={item.title}
                  className="bg-bg rounded-3xl p-8 text-center"
                >
                  <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mx-auto mb-4">
                    {item.icon}
                  </div>
                  <h3 className="font-display text-lg text-text-main font-semibold mb-2">
                    {item.title}
                  </h3>
                  <p className="font-body text-text-sub text-sm leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              ))}
      ...
      <section className="py-20 px-4 bg-bg">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <p className="font-display italic text-primary text-sm mb-1">
                phân tích cảm xúc
              </p>
              <h2 className="font-display text-4xl md:text-5xl text-text-main font-bold leading-tight">
                Hiểu rõ cảm xúc
              </h2>
              <p className="font-display italic text-primary text-3xl md:text-4xl mt-1">
                mỗi ngày
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={tag.label}
                  className="flex items-center gap-1.5 px-4 py-2 bg-white rounded-full font-ui text-sm text-text-main shadow-sm border border-primary/10"
                >
                  {tag.emoji} {tag.label}
                </span>
              ))}
            ...
            {[
              ...
              >
                ...
                <div className="px-4 py-3">
                  ...
                  <p className="font-body text-xs text-text-sub mt-0.5">
                    {card.sub}
                  </p>
                </div>
              </motion.div>
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            ...
            >
              ...
              <span className="font-ui font-semibold text-white text-base">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <p className="font-ui text-text-sub text-xs uppercase tracking-widest mb-4">
              Luôn bên bạn
            </p>
            <h2 className="font-display text-3xl md:text-4xl text-text-main leading-tight mb-6">
              Hãy tìm thấy bình tĩnh
              <br />
              của cùng Mindora
            </h2>
            <p className="font-body text-text-sub text-base leading-relaxed mb-8">
              ...
              Dora luôn ở đây, sẵn sàng lắng nghe và đồng hành cùng bạn mỗi
              ngày.
            </p>
            <button
              onClick={() => navigate("/chat")}
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-primary flex-shrink-0 flex items-center justify-center font-display text-sm font-bold text-white">
                  D
                </div>
              ...
              <div className="flex items-start gap-3 flex-row-reverse">
                ...
                <div className="bg-primary/20 rounded-3xl rounded-tr-sm p-3 max-w-[76%] shadow-bubble">
                  <p className="font-body text-sm text-text-main">
                    Mình hơi căng thẳng, công việc nhiều quá.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="bg-white rounded-3xl rounded-tl-sm p-3 max-w-[76%] shadow-bubble">
                  <p className="font-body text-sm text-text-main">
                    Mình nghe bạn. Hãy kể thêm về điều đó nhé.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <p className="font-body text-bg/60 text-base leading-relaxed mb-8">
              Bắt đầu chăm sóc sức khỏe tâm thần ngay hôm nay - miễn phí, không
              phán xét.
            </p>
            <button
              onClick={() => navigate("/chat")}
            ...
            <div className="w-56 h-[28rem] bg-white/8 border border-white/20 rounded-[2.5rem] overflow-hidden relative">
              ...
              <div className="p-4 flex flex-col gap-3 h-full pb-8">
                ...
                <div className="bg-primary/30 rounded-2xl p-3 ml-5">
                  <p className="font-body text-white/75 text-xs">
                    Mình đang lo lắng về công việc...
                  </p>
                </div>
                <div className="bg-white/10 rounded-2xl p-3">
                  <p className="font-body text-white/75 text-xs">
                    Mình hiểu. Bạn muốn kể thêm không?
                  </p>
                </div>
                <div className="mt-auto bg-white/10 rounded-2xl p-3">
                  <p className="font-ui text-white/55 text-xs mb-3">
                    Tâm trạng hôm nay
                  </p>
                  <div className="flex gap-2 justify-around">
                    {[
                      ...
                      >
                        ...
                        />
                        <span
                          className={`font-ui text-[9px] ${i === 0 ? "text-white/80" : "text-white/30"}`}
                        >
                          {m.label}
                        </span>
                      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            ...
            {[
              ...
              <div key={col.title}>
                <p className="font-ui text-bg text-sm font-semibold mb-4">
                  {col.title}
                </p>
                <ul className="flex flex-col gap-2.5">
                  {col.links.map((link) => (
                    <li key={link}>
                      <a
                        href="#"
                        className="font-body text-bg/50 text-sm hover:text-bg transition-colors"
                      >
                        {link}
                      </a>
                    </li>
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
            <p className="font-ui text-bg/30 text-xs">
              © 2026 Mindora. Không thay thế chuyên gia tâm lý.
            </p>
            <p className="font-ui text-bg/30 text-xs">
              Đường dây hỗ trợ:{" "}
