        ...
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-body text-xs text-text-main font-semibold">
                {mood?.label}
              </span>
            </div>
          </div>
        ...
        {entry.tags?.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mt-2">
            {entry.tags.map((t) => (
              <Tag
                key={t}
                className="bg-bg text-text-sub border border-[#F0EBDC] text-[10px] py-0.5 px-2.5"
              >
                {t}
              </Tag>
            ))}
    ...
    >
      ...
      >
        ...
        <div className="mb-6 flex flex-col items-center">
          <p className="font-ui text-xs text-text-sub uppercase tracking-wider mb-2 text-center">
        ...
        <div className="mb-5">
          <label className="font-ui text-xs text-text-sub uppercase tracking-wider block mb-2">
            Lời tự sự của bạn
          </label>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <p className="font-ui text-xs text-text-sub uppercase tracking-wider">
              Từ khóa liên quan (phân cách bằng dấu phẩy)
            </p>
          </div>
          <input
            value={tags}
...
export default function JournalPage() {
  ...
  const allEntries = [...journals].sort(
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      {!todayMoodDone && (
        ...
        >
          ...
          <div className="absolute -right-8 -bottom-8 text-8xl opacity-15 rotate-12 select-none pointer-events-none">
            ✍️
          </div>

          <p className="font-display text-base md:text-lg text-text-main font-bold mb-1">
            Hôm nay bạn cảm thấy thế nào?
          </p>
          <p className="font-body text-xs text-text-sub mb-4">
            Ghi lại cảm xúc hôm nay chỉ mất 1 phút để Dora đồng hành cùng bạn!
          </p>
        ...
        <div className="flex flex-col gap-5">
          {allEntries.length > 0 ? (
            ...
            <div className="text-center py-14 card border border-[#E8E1CF] bg-white">
              ...
              <p className="font-display text-lg text-text-main font-semibold">
                Chưa có trang nhật ký nào
              </p>
              <p className="font-body text-xs text-text-sub mt-1.5 mb-5">
                Hãy bắt đầu lưu giữ cảm xúc của bạn từ hôm nay!
              </p>
              <Button
                icon={<Plus size={14} />}
                onClick={() => {
