        ...
        >
          ...
          >
            ...
            <div className="flex-1 p-6 md:p-10 flex flex-col justify-center bg-white">
              ...
              <div className="mb-6 mt-2">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  />
                  <span className="font-ui text-xs font-semibold text-primary uppercase tracking-wider">
                    Mindora
                  </span>
                </div>
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <span className="font-ui text-[11px] text-text-sub/70 uppercase tracking-wider">
                  hoặc
                </span>
                <span className="flex-1 h-px bg-primary/10" />
              </div>
            ...
            <div className="hidden md:flex flex-1 relative bg-secondary-dark overflow-hidden">
              ...
              <div className="absolute inset-0 bg-[url('/background.png')] bg-cover bg-center opacity-85 scale-[1.08] animate-ken-burns pointer-events-none" />
              ...
              <div className="relative z-10 w-full h-full flex flex-col justify-between p-10 text-white select-none">
                <div>
                  ...
                  <p className="font-body text-xs text-white/70 max-w-[280px] leading-relaxed">
                    "Lắng nghe, thấu hiểu và cùng bạn vượt qua những khoảnh khắc
                    căng thẳng nhất."
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-ui text-[10px] text-white/50 uppercase tracking-widest">
                    Dora 001
                  </span>
                </div>
              </div>
